...
define noalias noundef ptr @seq_alloc(i64 noundef %0) local_unnamed_addr #0 {
  %2 = tail call ptr @malloc(i64 noundef %0) #5
  ret ptr %2
}
...
; Function Attrs: mustprogress nofree nounwind ssp willreturn memory(inaccessiblemem: readwrite) uwtable(sync)
define noalias noundef ptr @seq_alloc_atomic(i64 noundef %0) local_unnamed_addr #0 {
  %2 = tail call ptr @malloc(i64 noundef %0) #5
  ret ptr %2
}

; Function Attrs: mustprogress nounwind ssp willreturn memory(argmem: readwrite, inaccessiblemem: readwrite) uwtable(sync)
define noalias noundef ptr @seq_realloc(ptr nocapture noundef %0, i64 noundef %1, i64 noundef %2) local_unnamed_addr #2 {
  %4 = tail call ptr @realloc(ptr noundef %0, i64 noundef %1) #6
  ret ptr %4
}
...
; Function Attrs: mustprogress nounwind ssp willreturn memory(argmem: readwrite, inaccessiblemem: readwrite) uwtable(sync)
define void @seq_free(ptr nocapture noundef %0) local_unnamed_addr #2 {
