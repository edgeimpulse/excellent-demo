...
@export
def generate_features(input: np.ndarray[float, 1], frame_size: int, fft_size: int):
    input_reshaped = np.reshape(input, (-1, frame_size))
    return power_spectrum(input_reshaped, fft_size)
